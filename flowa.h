...
private: //private stuff can only be seen/used by fellow class members
	...
	sf::CircleShape body; //SFML lets you set the number of sides of a circle, so this is how we make a triangle!
...
public: //public stuff can be seen/used by errbody in the clurb
	...
	flowa(int x, int y, int c[3]); //parameterized constructor
